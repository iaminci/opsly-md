  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "bg-background text-foreground border-border border-2 font-heading shadow-shadow rounded-base text-[13px] flex items-center gap-2.5 px-4 py-3 w-fit max-w-[min(356px,calc(100vw-2rem))] [&:has(button)]:justify-between",
